Perfect 👍
Below is **ONE SINGLE FILE** (`README.md`) that includes **everything you asked for**, clearly structured and ready to use.

You can **copy–paste this entire content into one file** named **`README.md`**.
